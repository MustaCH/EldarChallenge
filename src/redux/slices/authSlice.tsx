...
export const selectIsAuthorized = (state: { auth: UserState }) =>
  state.auth.isAuthorized;
export const selectUserRole = (state: { auth: UserState }) => state.auth.role;
export const isRole = (role: string) => (state: { auth: UserState }) =>
